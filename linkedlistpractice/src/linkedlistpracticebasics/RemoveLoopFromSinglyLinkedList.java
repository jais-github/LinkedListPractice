...
private static ListNode head;
	...
	public static void main(String[] args) {
		 ...
		 * third=new ListNode(2); ListNode fourth=new ListNode(3);
		 * 
		 * 
		...
		/*
		 * //remove a given key from singly linked list sll.deleteNode(14);
		 * sll.display();
		 */
		
		/*
		 * //contains loop or not sll.createLoopInLinkedList();
		 * System.out.println((sll.conatainsLoop()));
		 */
		
		/*
		 * //starting point of the loop sll.createLoopInLinkedList();
		 * System.out.println((sll.conatainsLoop()));
		 * System.out.println(sll.startNodeInALoop().data);
		 */
		
		
		  //remove loop sll.createLoopInLinkedList();
		  System.out.println(sll.conatainsLoop());
		  System.out.println(sll.startNodeInALoop().data); sll.removeLoop();
		  sll.display();
